...
ARCHITECTURE behavior OF hw_image_generator IS
	...
	signal clock_conter : std_logic_vector(15 downto 0);
	signal jump	:	INTEGER RANGE 0 TO 100:= 0;  --buttcheese
...
BEGIN
	...
	BEGIN
		...
		IF(disp_ena = '1') THEN		--display time
			IF(row > 920 AND row < 1000 AND column > (650-jump) And column < (750-jump)) THEN
				red <= (OTHERS => '1');
				green	<= (OTHERS => '1');
				--blue <= (OTHERS => '0');
			--ELSE
